...
class Spot(pbrspot.body.Body):
    ...
    def __init__(self):
        ...
        self.urdf_file = curr_folder_path / 'models/spot_description/new_spot.urdf'
    ...
    def set_body_point(self, point):
        self.set_body_pose((point, self.get_quat()))
...
class Manipulator(object):
    ...
    def ComputeIK(self, hand_pose_worldF, rng, robot_worldF=None, seed_q=None):
        ...
        # convert the hand pose to the wrist pose
        wrist_link = self.__robot.link_from_name('arm_link_wr1')
        hand_link = self.__robot.link_from_name('hand_frame')
        hand2wrist_pose = self.__robot.get_relative_pose(wrist_link, hand_link)
        hand2wrist_mat = pbrspot.geometry.tform_from_pose(hand2wrist_pose)
        wrist_pose_worldF = numpy.dot(hand_pose_worldF, hand2wrist_mat)
